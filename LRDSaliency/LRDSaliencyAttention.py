...
def get_correlation_layer(conv3_pool_l,conv3_pool_r,max_displacement=20, stride2=2,height_8=14,width_8=14):
    ...
    for i in range(-max_displacement, max_displacement+stride2,stride2):
        for j in range(-max_displacement, max_displacement+stride2,stride2):
            ...
            current_layer = dotLayer([conv3_pool_l,conv3_pool_r])
...
class Model:
    ...
    def LRDSaliency_inference(left, right, is_training):
        with tf.variable_scope("flownet", reuse=tf.AUTO_REUSE):
            ...
            deconv1_a = tf.layers.conv2d_transpose(x, 512, 3, 4, padding='SAME', name='deconv1_a')
            ...
            deconv2_a = tf.layers.conv2d_transpose(deconv1_a, 128, 7, 3, padding='VALID', name='deconv2_a')
            ...
            deconv3_a = tf.layers.conv2d_transpose(deconv2_a, 32, 3, 2, padding='SAME', name='deconv_3_a')
            ...
            predict = tf.layers.conv2d_transpose(deconv3_a, 1, 3, 2, padding='SAME', name='predict')
