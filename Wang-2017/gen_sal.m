...
SalFiles{left} = fullfile('/data/qiudan/3DSaliency_Program/Feng_Shao_SIRQA/NBU_SIRQA_Database/CASNet_II_IDSA_left/');
SalFiles{right} = fullfile('/data/qiudan/3DSaliency_Program/Feng_Shao_SIRQA/NBU_SIRQA_Database/CASNet_II_IDSA_right/');
%SalFiles{left} = fullfile('/data/qiudan/3DSaliency_Program/Cropping/Wang-2017-Stcvessd--master/U2Net_sal/sal_left/');
%SalFiles{right} = fullfile('/data/qiudan/3DSaliency_Program/Cropping/Wang-2017-Stcvessd--master/U2Net_sal/sal_right/');
...
for index = 1: nimgs       
        ...
        % outfolder = fullfile('/data/qiudan/3DSaliency_Program/Feng_Shao_SIRQA/NBU_SIRQA_Database/u2net_sal_optimization/',ImgName{left});
        outfolder = fullfile('/data/qiudan/3DSaliency_Program/Feng_Shao_SIRQA/NBU_SIRQA_Database/Wang-2017-optimization/',ImgName{left});
        disp(outfolder)
...
%         Sal{right} = double(imread(fullfile(SalFiles{right}, [ImgName{left} '.jpg'])));
